...
<head>
    ...
    <title>Đăng Nhập - VTQ ADMIN</title>
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('admin.login.submit') }}">
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid">
                                                <button class="btn btn-block text-white" style="background-color:#3c8c32;" type="submit">Đăng Nhập</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center py-3">
                                    <div class="small">
                                        <a href="#">Bạn chưa có tài khoản admin? Hãy liên hệ quản trị viên hệ thống.</a>
                                    </div>
                                </div>
                            </div>
                        </div>
